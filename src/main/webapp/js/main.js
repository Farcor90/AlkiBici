...
$(document).ready(function () {
    ...
    getUsuario().then(function () {
        ...
        $("#ordenar-modalidad").click(ordenarPeliculas);
    });
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (parsedResult != false) {
                ...
                console.log("Error recuperando los datos de las bicicletas");
            }
        }
    });
}
    ...
    $.each(peliculas, function (index, pelicula) {
        ...
        if (pelicula.disponibles > 0) {
            ...
            contenido += '<tr><th scope="row">' + pelicula.id + '</th>' +
                    '<td>' + pelicula.modelo + '</td>' +
                    '<td>' + pelicula.modalidad + '</td>' +
                    '<td>' + pelicula.marca + '</td>' +
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (parsedResult != false) {
                ...
                console.log("Error en la reserva de la bicicleta");
            }
        }
    });
