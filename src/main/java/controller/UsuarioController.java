...
public class UsuarioController implements IUsuarioController {
    ...
    public String verCopias(String username) {
        ...
        try {
            ...
            devolverPeliculas(username, disponibles);
    ...
    @Override
    public String devolverPeliculas(String username, Map<Integer, Integer> disponibles) {

        DBConnection con = new DBConnection();

        try {
            for (Map.Entry<Integer, Integer> pelicula : disponibles.entrySet()) {
                int id = pelicula.getKey();
                int num_disponibles = pelicula.getValue();

                String sql = "Update peliculas set disponibles = (Select disponibles + " + num_disponibles +
