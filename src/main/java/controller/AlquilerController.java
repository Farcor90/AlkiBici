...
public class AlquilerController implements IAlquilerController {
    ...
    public String listarAlquileres(String username) {
        ...
        String sql = "Select l.id, l.modelo, l.modalidad, l.novedad, a.fecha from peliculas l "
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Alquiler alquiler = new Alquiler(id, fechaAlquiler, novedad, modalidad, modelo);
